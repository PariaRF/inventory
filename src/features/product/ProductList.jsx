function ProductList({ products, onDelete }) {
  return (
    <div>
      <h2 className="text-secondary-500 font-bold border-b-primary-500 border-b">
        Product List
      </h2>
      <div className="max-h-[180px] overflow-y-auto scrollbar-thin scrollbar-thumb-rounded-md scrollbar-thumb-primary-500 pr-3">
        {products.map((product) => (
          ...
          >
            <span className="block max-w-[80px] truncate whitespace-nowrap overflow-hidden md:max-w-none">
              {product.title}
            </span>
